...
- 🌱 **Prompt Garden**：发现、导入和收藏优质提示词，支持版本历史、可复现示例和来源绑定
- ⭐ **智能收藏**：资源感知的提示词资产，支持版本历史、可复现示例、媒体支持和工作区应用
...
### Prompt Garden 与智能收藏
- 🌱 **提示词发现**：浏览和发现社区优质提示词
- 📥 **导入与收藏**：导入提示词及其元数据、媒体、示例和来源绑定
- ⭐ **资源感知资产**：收藏作为可复用提示词资产，支持版本历史
- 🔗 **来源绑定**：追踪提示词来源，维护可复现示例
